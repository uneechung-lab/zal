...
export default function FeedbackSystem({ userName, userEmail, currentPath, showAdminView = false, customBottom }) {
  ...
  return (
    <>
      <div className="FeedbackSystem-trigger-container" style={{ position: "fixed", bottom: customBottom !== undefined ? customBottom : (showAdminView ? 24 : 96), right: 24, display: "flex", flexDirection: "column", gap: 12, zIndex: 950 }}>
