...
export default function App() {
  ...
  const fetchCategories = async () => {
    const { data, error } = await supabase.from('allowed_categories').select('name').order('created_at', { ascending: false });
  ...
  return (
      ...
      <header className="admin-header">
        <div className="header-inner">
          ...
          <div className="header-meta" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <button 
              className={`header-nav-btn desktop-only ${currentView === "categories" ? "active" : ""}`}
            ...
            <button 
              className={`header-nav-btn desktop-only ${currentView === "print" ? "active" : ""}`}
            ...
            <button 
              className={`header-nav-btn desktop-only ${currentView === "leaves" ? "active" : ""}`}
            ...
            <button 
              className={`header-nav-btn desktop-only ${currentView === "admins" ? "active" : ""}`}
    ...
    {currentView === "print" && (() => {
      ...
      <div className="mobile-bottom-nav">
        ...
        <button 
          className={`mobile-nav-item ${currentView === "print" ? "active" : ""}`} 
          onClick={() => navigateWithConfirm("print")}
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            <polyline points="6 9 6 2 18 2 18 9"></polyline>
        ...
        <button 
          className={`mobile-nav-item ${currentView === "leaves" ? "active" : ""}`} 
          onClick={() => navigateWithConfirm("leaves")}
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            <rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect>
        ...
        <button 
          className={`mobile-nav-item ${currentView === "admins" ? "active" : ""}`} 
          onClick={() => navigateWithConfirm("admins")}
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
